     ...
     <div class="flashback-teaser-wrapper">
          <div class="flashback-teaser-container">
               ...
               <div class="flashback-teaser-boxes">
                    ...
                    ?>
                         <div class="flashback-teaser-box sud-shadow" style="background-image:url('<?php echo $page['background_image']; ?>');">
                              <div class="flashback-teaser-box-layer"></div>
                              <a href="<?php echo $page['page']['url']; ?>" style="width:100%; height:100%; padding: 20% 10%;">
                                   <h4 class="fxl"><?php echo $page['page']['title']; ?></h4>
                              </a>
                         </div>
                    <?php } } ?>
               </div>
