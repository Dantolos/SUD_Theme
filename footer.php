...
<div class="footer-wrapper">
     <div class="footer-container">
          ...
          <div class="footer-left">
               <h5 class="c-white"><?php echo get_field("address", "option")[
                   "company_name"
               ]; ?></h5>
               <p class="c-white"><?php echo get_field("address", "option")[
                   "address"
               ]; ?></p>
               <a class="c-white" href="mailto:<?php echo get_field(
                   "address",
                   "option"
               )["e-mail"]; ?>">E-Mail</a>
          </div>
          ...
          <div class="footer-bottom-line">
               ...
               <div class="lightbox-wrapper" lbtarget="newsletter">
                    ...
                    <div class="lightbox-container" >
                         ...
                         <div class="lightbox-content">
                              <h3 class="c-white"><?php echo get_field(
                                  "newsletter",
                                  "option"
                              )["lightbox_content"]["title"]; ?></h3>
                              <p class="c-white"><?php echo get_field(
                                  "newsletter",
                                  "option"
                              )["lightbox_content"]["text"]; ?></p>
                              <?php echo get_field("newsletter", "option")[
                                  "lightbox_content"
                              ]["form"]; ?>
                         </div>
               ...
               <?php if (get_field("channels", "option")) {
